...
Argument::Argument(const ArgumentData& data)
    : longName(data.longName), shortName(data.shortName), description(data.description),
      needValue(data.needValue), valueType(data.valueType), defaultValue(data.defaultValue),
